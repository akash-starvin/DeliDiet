...
import com.example.android.belidiet.firebase.FBAddMealsGetSet;
...
public class AddMeal extends AppCompatActivity {
    ...
    private String name, cost, des, url,pack;
    private StorageReference storageReference;
    private FirebaseDatabase database = FirebaseDatabase.getInstance();
    private DatabaseReference myRef = database.getReference( Constants.MEAL_LIST_PATH);
    private Uri uri;
